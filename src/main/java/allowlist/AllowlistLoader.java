 ...
 *
 * Supported lines:
 * - Blank lines (or only spaces): ignored
 * - Comments: lines starting with '#': ignored
 * - Settings: lines starting with '@', e.g. @DISALLOW_NULL_LITERAL=true
 * - Allow entries: OWNER#member
 */
public final class AllowlistLoader {
    ...
    static AllowlistConfig loadFromStreamForTests(java.io.InputStream in) throws FileNotFoundException {
        return loadFromStream(in);
    }
