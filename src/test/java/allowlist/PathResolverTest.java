...
public class PathResolverTest {
    ...
    void windows_usesAPPDATAWhenPresent() {
        ...
        assertEquals(tmp.resolve("Roaming").resolve("javaWhitelist").resolve("allowlist.txt").normalize(),
                p.normalize());
    }
    ...
    void linux_usesXdgConfigHomeWhenSet() {
        ...
        assertEquals(tmp.resolve("xdg").resolve("javaWhitelist").resolve("allowlist.txt").normalize(), p.normalize());
    }
